...
En esta lección vamos a ver el bucle while. Como vimos en 008.py, hay varias
palabras reservadas, y las que vamos a usar esta vez serán "while" y "break".
Veamos un snippet de un bucle while, con el que trabajaremos el resto de la lección:
"""
...
de tiempo para explicarlo. Empecemos por lo que es la línea 9:
...
Esta línea pide la entrada del usuario y la guarda en nuestra variable "user_tiene_hermanos".
