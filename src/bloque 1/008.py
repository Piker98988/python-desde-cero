...
# ! El código muerto (código que no se ejecutará en ningún momento)
# ! será indicado con una exclamación al principio del comentario
if es_hombre and es_mujer:              # Condición falsa
    print("Eres hombre y eres mujer")   
    # ! Código muerto
...
if es_hombre and es_mujer:              # Condición falsa
    ...
    print("Eres mujer")                 
    # ! Código muerto
else:                                   # ! Si ninguna de las anteriores resulta verdadera:
    print("No eres nada")
    # Esta línea de código es nuestro "por si acaso"
